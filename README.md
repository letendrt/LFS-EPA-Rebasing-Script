...
2) **Forwarding Public Key**: Forward your public key to IT. They will add it to the devdv account. Once done (and received the required permissions from IT), follow the instructions below to get started.
